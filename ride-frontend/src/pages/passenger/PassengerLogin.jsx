...
import { User, Mail, Lock, Eye, EyeOff, ChevronLeft, CheckCircle } from 'lucide-react'
...
const PassengerLogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            const { token, requiresPasswordChange, role, user } = data
            ...
            if (role === 'PASSENGER') {
                ...
                toast.error('Unauthorized access. Passenger role required.')
                authService.logout()
            }
        } catch (error) {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col md:flex-row bg-professional-blue relative">
            <Link
                to="/login-select"
            ...
            <div className="md:w-1/2 bg-professional-blue floating-shapes p-12 md:p-24 flex flex-col justify-center text-white relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-5xl font-black leading-tight">Passenger Portal</h1>
                        <p className="text-xl text-blue-50/80 max-w-md">
                            Find rides, save money, and travel comfortably. Your journey starts here with SmartRide.
                        </p>
                    </div>
            ...
            <div className="md:w-1/2 p-8 md:p-24 flex flex-col justify-center relative bg-white">
                <div className="max-w-md w-full mx-auto space-y-12">
                    <div className="space-y-4">
                        <h2 className="text-4xl font-black text-gray-800">Passenger Login</h2>
