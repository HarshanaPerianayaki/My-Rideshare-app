...
const PassengerRegister = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            await authService.registerPassenger(formData)
                    ...
                    <div className="p-8 md:p-12 pb-0">
                        ...
                        <div className="flex justify-center mb-12">
                            <div className="bg-gray-100 p-1.5 rounded-full flex gap-2 border border-gray-200">
                                <div className="px-8 py-2.5 rounded-full font-black bg-gradient-to-r from-green-600 to-emerald-700 text-white shadow-lg">
                                    🚗 Passenger
                                </div>
                                <Link to="/driver/register" className="px-8 py-2.5 rounded-full font-black text-gray-500 hover:text-gray-700 transition">
                                    🚕 Driver
                                </Link>
                            </div>
                        </div>
                                ...
                                {step < 4 ? (
                                    ...
                                    >
                                        {loading ? (
                                            ...
                                            <>Register as Passenger <CheckCircle size={22} /></>
                                        )}
                                    </button>
                                )}
                            </div>
