...
import { Car, Mail, Lock, Eye, EyeOff, ChevronLeft, CheckCircle } from 'lucide-react'
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (role === 'DRIVER') {
                ...
                toast.error('Unauthorized access. Driver role required.')
                authService.logout()
            }
        } catch (error) {
        ...
        <div className="w-full min-h-screen flex flex-col md:flex-row bg-white relative">
            ...
            <div className="md:w-1/2 bg-professional-blue floating-shapes p-12 md:p-24 flex flex-col justify-center text-white relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-5xl font-black leading-tight">Driver Portal</h1>
                        <p className="text-xl text-blue-50/80 max-w-md">
                            Drive, earn, and manage your rides. Join our network of trusted drivers and start your journey today.
                        </p>
                    </div>
            ...
            <div className="md:w-1/2 p-8 md:p-24 flex flex-col justify-center relative bg-gradient-to-br from-white via-blue-50/30 to-white">
                <div className="max-w-md w-full mx-auto space-y-12">
                    <div className="space-y-4">
                        <h2 className="text-4xl font-black text-gray-800">Driver Login</h2>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    placeholder="driver@smartride.com"
                                />
                            </div>
                        </div>
